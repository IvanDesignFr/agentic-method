...
|-------|-------------|-------------|-----------------|
| **Action** | Ce qu'on ferait concretement | "Ajouter un mode revision pre-cours" | "Ameliorer l'UX" (trop vague) |
| **Resultat** | Metrique observable et mesurable | "Augmenter la retention vocabulaire de 30% a 70% apres 2 semaines" | "Rendre les gens contents" (pas mesurable) |
| **Persona** | Qui exactement | "Debutants catamaran en club (< 1 an)" | "Les gens" (trop large) |
| **Evidence** | Donnees comportementales reelles | "3/5 interviewes ont cherche du vocabulaire en ligne avant leur cours" | "On pense que c'est mieux" (opinion) |
