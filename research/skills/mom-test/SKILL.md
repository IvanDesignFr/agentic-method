...
|-------------------|------------------------|
| "Tu utiliserais notre outil ?" | "Comment tu resous ce probleme aujourd'hui ? T'as cherche des trucs ?" |
...
Adapter au projet courant :
- Decrire le produit en 1 ligne
- Cible : [segment principal B2C/B2B]
- Phase : [prototype / MVP / production]
- Questions ouvertes : [les hypotheses cles non encore testees]

Segments definis dans `docs/research/README.md`.
